...
import ca.bc.gov.educ.api.gradbusiness.model.dto.institute.District;
import ca.bc.gov.educ.api.gradbusiness.service.institute.DistrictService;
import ca.bc.gov.educ.api.gradbusiness.util.EducGradBusinessApiConstants;
import ca.bc.gov.educ.api.gradbusiness.util.GradValidation;
import ca.bc.gov.educ.api.gradbusiness.util.PermissionsConstants;
import ca.bc.gov.educ.api.gradbusiness.util.ResponseHelper;
...
public class DistrictController {
    ...
    @PutMapping(EducGradBusinessApiConstants.GRAD_DISTRICT_URL_MAPPING_V2 + EducGradBusinessApiConstants.PUT_DISTRICTS_MAPPING)
    @PreAuthorize(PermissionsConstants.UPDATE_GRAD_gradbusiness_CACHE)
    ...
    @GetMapping(EducGradgradbusinessApiConstants.GRAD_DISTRICT_URL_MAPPING_V2)
    ...
    @GetMapping(EducGradgradbusinessApiConstants.GRAD_DISTRICT_URL_MAPPING_V2 + EducGradgradbusinessApiConstants.GET_DISTRICT_BY_ID_MAPPING)
    @PreAuthorize(PermissionsConstants.READ_SCHOOL_DATA)
    ...
    @GetMapping(EducGradgradbusinessApiConstants.GRAD_DISTRICT_URL_MAPPING_V2 + EducGradgradbusinessApiConstants.GET_DISTRICTS_BY_SCHOOL_CATEGORY_MAPPING)
    @PreAuthorize(PermissionsConstants.READ_SCHOOL_DATA)
